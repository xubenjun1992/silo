...
export interface RTokenImplInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BURNER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface RTokenImpl extends BaseContract {
  connect(runner?: ContractRunner | null): RTokenImpl;
  waitForDeployment(): Promise<this>;

  interface: RTokenImplInterface;
