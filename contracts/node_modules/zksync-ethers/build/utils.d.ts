 ...
 * @readonly
 */
export declare const L2_NATIVE_TOKEN_VAULT_ABI: ethers.utils.Interface;
/**
 * Encodes the transfer data for the NativeTokenVault withdraw call.
 */
export declare function encodeNativeTokenVaultTransferData(amount: BigNumberish, receiver: Address, token: Address): string;
/**
