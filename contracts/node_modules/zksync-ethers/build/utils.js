 ...
 * @readonly
 */
exports.L2_NATIVE_TOKEN_VAULT_ABI = new ethers_1.utils.Interface([
...
function encodeNativeTokenVaultTransferData(amount, receiver, token) {
    return ethers_1.utils.defaultAbiCoder.encode(['uint256', 'address', 'address'], [amount, receiver, token]);
}
