...
const Il1NullifierFactory_1 = require("./typechain/Il1NullifierFactory");
const Il1AssetRouterFactory_1 = require("./typechain/Il1AssetRouterFactory");
function AdapterL1(Base) {
    return class Adapter extends Base {
         ...
         */
        getL1AssetRouter(address) {
            return Il1AssetRouterFactory_1.Il1AssetRouterFactory.connect(address, this._signerL1());
        }
        /**
        ...
        async getL1Nullifier() {
            ...
            const l1AssetRouter = this.getL1AssetRouter(await assetRouter.L1_ASSET_ROUTER());
            const l1Nullifier = await l1AssetRouter.L1_NULLIFIER();
            return Il1NullifierFactory_1.Il1NullifierFactory.connect(l1Nullifier, this._signerL1());
        }
        /**
        ...
        async finalizeWithdrawal(withdrawalHash, index = 0, overrides) {
            const finalizeWithdrawalParams = await this.finalizeWithdrawalParams(withdrawalHash, index);
            ...
            return await l1Nullifier.finalizeDeposit(finalizeL1DepositParams, overrides !== null && overrides !== void 0 ? overrides : {});
        }
        /**
        ...
        async isWithdrawalFinalized(withdrawalHash, index = 0) {
            ...
            if (await this._providerL2().isBaseToken(sender)) {
                ...
                l1Bridge = Il1SharedBridgeFactory_1.Il1SharedBridgeFactory.connect(sender === utils_1.L2_ASSET_ROUTER_ADDRESS
                    ? await l2Bridge.l1Bridge()
                    : await l2Bridge.l1SharedBridge(), this._providerL1());
            }
